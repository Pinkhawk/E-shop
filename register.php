...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/fontawesome.min.css"
       ...
       var val = document.myform.mob.value;
       if(val.length<10){
       ...
       var pass = document.myform.pass1.value;
       if(pass.length<8){
       
         alert("password length should be 8 digits");
         document.myform.pass1.focus();
         return false;
       ...
       if(pass ==("^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,})")){
         ...
         alert("Password should containing  \n 1 .Special character \n 1 .Small Letter \n 1. Capital letter");
         return false;
       }*/
       ...
       var regex = /^[A-Za-z0-9 ]+$/
               ...
               var isValid = regex.test(document.getElementById("pswd1").value);
               if (!isValid) {
                   return true;}
               else {
...
<body>
 ...
 <div class="register-photo">
    <div class="form-container">
        ...
        <form action="register.php" method="POST" name="myform" onsubmit="return(validate())">
            <h2 class="text-center"><strong>Create</strong> an account.</h2>
            <div class="form-group"><input class="form-control" type="text" name="fname" placeholder="Enter Your Name"></div>
            <div class="form-group"><input class="form-control" type="email" name="email" placeholder="Email"></div>
            <div class="form-group"><input type="password" class="form-control" id="pswd1" placeholder="Enter Password " name="pass1" maxlength="8" required></div>
            <div class="form-group"><input type="password" class="form-control" id="pswd2" placeholder="Confirm Password" name="pass2" maxlength="8" required></div>
            <div class="form-group"><input class="form-control" type="text" name="contact" placeholder="Contact no." maxlength="12"></div>
            <div class="form-group"><textarea class="form-control" name="address" placeholder="enter your fulladdress"></textarea></div>
            ...
            <div class="form-group"><button class="btn btn-success btn-block" name="Register" type="submit">Sign Up</button></div><a class="already" href="login.php">You already have an account? Login here.</a>
        </form>
    </div>
</div>
...
$passwordwe = mysqli_real_escape_string($conn, $_REQUEST['pass1']);
$password = md5($passwordwe);//encrypt the password before saving in the database
...
$insert = mysqli_query($conn,"INSERT INTO Register_users (Name, Email, Password,Contact,Address)VALUES('$username', '$email', '$password','$contact','$address')");

if($insert)
{
  echo "
  <script> 
  window.alert('Successfully Registered Click Ok to log in');
...
// checking username and email is if already exists in database
